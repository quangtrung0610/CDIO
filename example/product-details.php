            ...
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet" id="frmsanphamchitiet" method="post" action="">
                        ...
                        ?>
                        <input type="hidden" name="Pro_ID" id="Pro_ID" value="<?= $sanphamRow['Pro_ID'] ?>" />
                        <input type="hidden" name="Pro_Name" id="Pro_Name" value="<?= $sanphamRow['Pro_Name'] ?>" />
                        <input type="hidden" name="sp_gia" id="sp_gia" value="<?= $sanphamRow['sp_gia'] ?>" />
                        <input type="hidden" name="hinhdaidien" id="hinhdaidien" value="<?= empty($hinhsanphamdautien) ? '' : $hinhsanphamdautien['hPro_Name'] ?>" />
                        ...
                        <div class="wrapper row">
                                ...
                                <?php if (count($sanphamRow['danhsachhinhanh']) > 0) : ?>
                                    <div class="preview-pic tab-content">
                                        <?php foreach ($sanphamRow['danhsachhinhanh'] as $hinhsanpham) : ?>
                                            <div class="tab-pane <?= ($hinhsanpham == $hinhsanphamdautien) ? 'active' : '' ?>" id="pic-<?= $hinhsanpham['hPro_ID'] ?>">
                                                <img src="/php/myhand/assets/uploads/products/<?= $hinhsanpham['hPro_Name'] ?>" />
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                    <ul class="preview-thumbnail nav nav-tabs">
                                        <?php foreach ($sanphamRow['danhsachhinhanh'] as $hinhsanpham) : ?>
                                            <li class="<?= ($hinhsanpham == $hinhsanphamdautien) ? 'active' : '' ?>">
                                                <a data-target="#pic-<?= $hinhsanpham['hPro_ID'] ?>" data-toggle="tab">
                                                    <img src="/php/myhand/assets/uploads/products/<?= $hinhsanpham['hPro_Name'] ?>" />
                                                </a>
                                            </li>
                                        <?php endforeach; ?>
                            ...
                            <div class="details col-md-6">
                                <h3 class="product-title"><?= $sanphamRow['Pro_Name'] ?></h3>
                                <div class="rating">
                                    <div class="stars">
